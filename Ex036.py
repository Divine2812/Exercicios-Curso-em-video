...
print("\033[1;33m-=" * 20 + "\033[1;33m-\033[m")
if parc > porc:
    print("\033[31mInfelizmente seu empréstimo foi \033[4;33mnegado\033[31m. \nA parcela de seu empréstimo é maior que 30% de seu salário. ")
else: 
    print(f"\033[32mSeu empréstimo foi \033[4;32aprovado\033[32m! O total da parcela mensal foi de \033[4{parc:.2f}R$\033[32m!")
